...
function generateReading(deviceId: string): string {
  ...
  return JSON.stringify({
    ...
    sensors: [
      ...
      { id: "light_lux", value: randomInRange(100, 800) },
      { id: "pressure_pa", value: randomInRange(100800, 101500) },
      { id: "uv_index", value: randomInRange(1, 9) },
      { id: "pm1", value: randomInRange(3, 15) },
      { id: "pm25", value: randomInRange(8, 35) },
      { id: "pm4", value: randomInRange(10, 45) },
      { id: "pm10", value: randomInRange(15, 60) },
    ],
  });
}
