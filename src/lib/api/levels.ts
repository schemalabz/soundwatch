...
export function describeLevel(
  ...
  // Threshold on the ROUNDED value, which is what the reader actually sees.
  // Comparing the raw value would render a bare "88.0" for an l10 of 87.96 on a
  // top-bin interval — a confident-looking number at the ceiling, which is the
