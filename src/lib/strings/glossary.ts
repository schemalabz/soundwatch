...
export const GLOSSARY: Record<GlossaryKey, GlossaryEntry> = {
  ...
  spectrum: {
    ...
    long: "Ο ίδιος ήχος χωρισμένος σε 21 ζώνες, από τα μπάσα αριστερά ως τα πρίμα δεξιά. Χωρίς προσαρμογή στο πώς ακούει το αυτί, γι' αυτό δεν συγκρίνεται με τη Μέση. Πάνω από 12,5 kHz φαίνεται κυρίως ο θόρυβος του ίδιου του αισθητήρα — μετρημένο σε μία μονάδα δοκιμών, σε άδειο γραφείο μια νύχτα.",
  },
  clocks: {
    term: "Ώρα",
