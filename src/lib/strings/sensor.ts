...
export const sensorStrings = {
  ...
  spectrum: {
    ...
    noiseFloor: "θόρυβος αισθητήρα",
    noiseFloorNote:
      "οι αχνές ζώνες από 12,5 kHz δείχνουν κυρίως τον θόρυβο του ίδιου του αισθητήρα — έτσι μέτρησε μια μονάδα δοκιμών σε άδειο γραφείο μια νύχτα, και το γεμάτο γραφείο δεν τις άλλαξε",
  },
  log: {
